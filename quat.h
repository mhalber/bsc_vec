...
namespace bvu
{
    ...
    struct quat
    {
        ...
        // move to utils?
        static quat<T> ToQuaternion( const mat4<T> & matrix );
        static mat4<T> ToMat4 ( const quat<T> & quat );
    };
    ...
    // TODO check if this will give better or worse return by value optimization
    template <typename T>
    inline quat<T> quat<T>::
    ...
    {
        return quat<T>( this->re * constant,
                              this->im * constant ); // less calls here I guess...
    }
